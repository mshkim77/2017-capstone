...
class AudioFile(models.Model):
    ...
    converted_file = models.FileField(validators=[FileExtensionValidator(('wav',))],
                                      upload_to="converted_audio/%Y/%m/%d/", null=True)
...
class SampleAudioFeatures(models.Model):
    data_id = models.AutoField(primary_key=True, unique=True, editable=False)

    audio = models.OneToOneField(AudioFile, on_delete=models.CASCADE, null=True)
